...
public class BorderInventory extends CoreInventory {
    ...
    public BorderInventory(Player p, Plot plot) {
        ...
        setItem(InventorySlot.ROW_1_SLOT_2, new ItemBuilder(Material.IRON_FENCE, 1).displayName("§eEisen-Gitter Rand").lore("§7Für §e1000 Coins §7verfügbar!").create(), e -> setRand(plot,p,1000, "101"));
