...
public class BorderInventory extends CoreInventory {
    ...
    public BorderInventory(Player p, Plot plot) {
        ...
        setItem(InventorySlot.ROW_3_SLOT_9, new ItemBuilder(Material.STONE_SLAB2, 1, 1).displayName("§eRand zurücksetzen").lore("§7Für §3100 Coins §7verfügbar!").create(), e -> setRand(plot, p, 100, "44:1"));
