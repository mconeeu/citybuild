...
public class BorderInventory extends CoreInventory {
    ...
    public BorderInventory(Player p, Plot plot) {
        ...
        setItem(InventorySlot.ROW_1_SLOT_2, new ItemBuilder(Material.IRON_FENCE, 1).displayName("§eEisen-Gitter Rand").lore("§7Für §31000 Coins §7verfügbar!").create(), e -> setRand(plot,p,1000, "101"));
        ...
        setItem(InventorySlot.ROW_1_SLOT_6, new ItemBuilder(Material.ENDER_STONE, 1).displayName("§eEndstone Rand").lore("§7Für §35000 Coins §7verfügbar!").create(), e -> setRand(plot,p,5000,"121"));
        ...
        setItem(InventorySlot.ROW_2_SLOT_1, new ItemBuilder(Material.ENDER_PORTAL_FRAME, 1).displayName("§eEndportal Rand").lore("§7Für §320000 Coins §7verfügbar!").create(), e -> setRand(plot,p,20000, "120"));
        ...
        setItem(InventorySlot.ROW_3_SLOT_9, new ItemBuilder(Material.DOUBLE_STONE_SLAB2, 1).displayName("§eRand zurücksetzen").lore("§7Für §3100 Coins §7verfügbar!").create(), e -> setRand(plot, p, 100, "44:1"));
