...
public class BorderInventory extends CoreInventory {
    ...
    public BorderInventory(Player p, Plot plot) {
        ...
        setItem(InventorySlot.ROW_1_SLOT_8, new ItemBuilder(Material.CAKE_BLOCK, 1).displayName("§eKuchen Rand").lore("§7Für §310000 Coins §7verfügbar!").create(), e -> setRand(plot,p,10000, "92"));
