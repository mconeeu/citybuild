...
public enum ShopCategory {
    ...
    SPAWN_EGGS("Tierspawn-Items", Material.PIG_SPAWN_EGG, new String[]{"§7§oKaufe dir hier Tier Spawneggs.", "§7§oDie Items stehen dir danach in", "§7§odeinem Inventar zur Verfügung."}, TraderSpawnEggsInventory.class),
    ...
    EXCLUSIVE("Exklusive-Items", Material.ENCHANTING_TABLE, new String[]{"§7§oKaufe dir hier Exklusive Items.", "§7§oDie Items stehen dir danach in", "§7§odein Inventar zu verfügung."}, TraderExclusiveInventory.class),
    MARKETPLACE("Markt-Liste", Material.BOOK, new String[]{"§7§o(EBAY SYSTEM)", "§7§oDie Preise der Aktuellen", "§7§oItems  an."}, MarketPlaceInventory.class),
